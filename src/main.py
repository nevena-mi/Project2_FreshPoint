...
def run(mode: str, angle: str | None = None) -> None:
    ...
    # 2. Monitor stage: pull fresh news across all known topics (no single
    # topic to search anymore — angle drives relevance in secondary_context()).
